...
<script
	src="<?php echo base_url('scripts/jquery/jquery.bxslider.min.js'); ?>"></script>
<script>
		...
		<ul class="bxslider">
			<li>
				<section>
					...
					<article>
						...
						opdrachten op Epos.<br />Verder werk ik samen met andere AON'ers aan de
						nodige opdrachten.
					</article>
					<article>
			...
			<li>
				<section>
					...
					<article>
						<h2><?php echo $this->lang->line('functie');?></h2>
						<p>Mijn functie binnen het project is groepsleider. Ik verzorg de
							communicatie tussen het team,<br />de vaklectoren en onze
							opdrachtgever (Ford Lommel Proving Grounds.</p>
