...
<html lang="nl-be">
	...
	<body>
		...
		<section id="profilepage" style="padding: 0 2%">
			...
			<?php } else {
            	echo $this->lang->line('loginMeldingIngelogd').'<br />';
           		echo $this->lang->line('loginMeldingNietIngelogd');?> <a href="<?php echo base_url('user/login'); ?>"><?php echo $this->lang->line('loginMelding2NietIngelogd');?></a>
            <?php }?>
        </section>
