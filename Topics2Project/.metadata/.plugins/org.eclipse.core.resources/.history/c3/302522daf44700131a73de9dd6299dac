...
<html lang="nl-be">
	...
	<body>
		...
		<section id="profilepage" style="padding: 0 2%">
            	...
            	<form id="submitnewemail" action="user/changeEmail" >
	            	<table>
						...
						<tbody>
						    ...
						    <tr>
	                			...
	                			<td><input id="confirmemail" name="emailconfirm" type="email" placeholder="<?php echo $this->lang->line('confirm');?>" class="tekstfield" required ></td>
                ...
                <form id="submitnewpassword" action="user/changePassword" >
	            	<table style="width: 100%">
						...
						<tbody>
						    ...
						    <tr>
						    	...
						    	<td><input id="oldpass" name="emailconfirm" type="password" placeholder="<?php echo $this->lang->line('loginPassword');?>" class="tekstfield" required >
